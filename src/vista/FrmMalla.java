...
import controlador.MallaController;
import controlador.TDA.listas.LinkedList;
import javax.swing.JOptionPane;
import vista.tablas.ModeloTablaMalla;
...
public class FrmMalla extends javax.swing.JFrame {
    ...
    MallaController pc = new MallaController();
    ModeloTablaMalla mp = new ModeloTablaMalla();
    ...
    private void cargarTabla(){
        mp.setMallas(pc.getMallas());
        tblMalla.setModel(mp);
        tblMalla.updateUI();
    }
    
    private boolean validar(){
        return !txtFechaRegistro.getText().trim().isEmpty() &&
               !txtNombreM.getText().trim().isEmpty() &&
    ...
    private void limpiar(){
        ...
        txtCarrera.setText("");
        pc.setMallas(null);
        pc.setMallas(new LinkedList<>());
        cargarTabla();
        //Actualizar tabla -BDD desaparece
        tblMalla.clearSelection();
        pc.setIndex(-1);
    }
    ...
    private void guardar() {
        if(validar()){
            try {
                pc.getMalla().setFechaRegistro(txtFechaRegistro.getText());
                pc.getMalla().setNombreMalla(txtNombreM.getText());
                pc.getMalla().setDuracion(txtDuracion.getText());
                pc.getMalla().setCarrera(txtCarrera.getText());
                
                //Guardar
                if(pc.getMalla().getId() == null){
                   if(pc.save()){
                    limpiar();
    ...
    private void cargarVista() {
        ...
        pc.setIndex(tblMalla.getSelectedRow());
        if(pc.getIndex().intValue() < 0){
            JOptionPane.showMessageDialog(null, "Selecciona una fila", 
                    "Error", JOptionPane.ERROR_MESSAGE);
        }else{
            try {
                pc.setMalla(mp.getMallas().get(pc.getIndex()));
                txtFechaRegistro.setText(pc.getMalla().getFechaRegistro());
                txtNombreM.setText(pc.getMalla().getNombreMalla());
                txtDuracion.setText(pc.getMalla().getDuracion());
                txtCarrera.setText(pc.getMalla().getCarrera());
            } catch (Exception e) {
                JOptionPane.showMessageDialog(null, e.getMessage(), 
                        "Error", JOptionPane.ERROR_MESSAGE);
            }
...
//            mp.setMallas(pc.buscarPrecioMenores(pc.getMallas(), criterio, semestre));
//            tblMalla.setModel(mp);
//            tblMalla.updateUI();
//        }catch (Exception ex){
...
>>>>>>> 3f942922e42c4fbf1b55a8da6771779430a4b906
        ...
        jLabel2.setText("Nombre de la Malla:");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtCarrera, javax.swing.GroupLayout.PREFERRED_SIZE, 365, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtFechaRegistro, javax.swing.GroupLayout.PREFERRED_SIZE, 365, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtNombreM, javax.swing.GroupLayout.PREFERRED_SIZE, 365, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtDuracion, javax.swing.GroupLayout.PREFERRED_SIZE, 365, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(12, 12, 12)
        ...
        jPanel2.getAccessibleContext().setAccessibleName("Malla");
        ...
        cbxCriterio.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "nombreMalla", "fechaRegistro" }));
        ...
        jPanel3.getAccessibleContext().setAccessibleName("Lista Mallas");
...
=======
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1110, 514, 170, 30));
>>>>>>> 3f942922e42c4fbf1b55a8da6771779430a4b906
