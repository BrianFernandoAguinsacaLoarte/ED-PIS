 ...
 * @author Usuario iTC
 */
public class FrmCicloTabla extends javax.swing.JFrame {
    
    CicloController dc = new CicloController();
    ModeloTablaCiclo mtd = new ModeloTablaCiclo();
    
    public FrmCicloTabla() {
        initComponents();
...
//    }
    ...
    private void initComponents() {
        ...
        labelRound1.setText("Registros de los Ciclos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCicloTabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmCicloTabla().setVisible(true);
            }
        });
    }
