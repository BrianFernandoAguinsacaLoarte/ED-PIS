 ...
 * @author Usuario iTC
 */
public class FrmRolTabla extends javax.swing.JFrame {
    
    RolController dc = new RolController();
    ModeloTablaRol mtd = new ModeloTablaRol();
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRolTabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmRolTabla().setVisible(true);
            }
        });
    }
