 ...
 * @author Usuario iTC
 */
public class FrmMateriaTabla extends javax.swing.JFrame {
    
    MateriaController dc = new MateriaController();
    ModeloTablaMateria mtd = new ModeloTablaMateria();
    
    public FrmMateriaTabla() {
        initComponents();
     ...
     private void cargarTabla(){
        mtd.setMaterias(dc.getMaterias());
...
//    }
    ...
    private void initComponents() {
        ...
        labelRound1.setText("Registro de las Materias");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMateriaTabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmMateriaTabla().setVisible(true);
            }
        });
    }
