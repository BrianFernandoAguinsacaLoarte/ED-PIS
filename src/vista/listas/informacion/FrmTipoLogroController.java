 ...
 * @author Usuario iTC
 */
public class FrmTipoLogroController extends javax.swing.JFrame {
    
    TipoLogroController dc = new TipoLogroController();
    ModeloTablaTipoLogro mtd = new ModeloTablaTipoLogro();
    
    public FrmTipoLogroController() {
        initComponents();
...
//    }
    ...
    private void initComponents() {
        ...
        labelRound1.setText("Registro de los tipos de Logro");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmTipoLogroController.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmTipoLogroController().setVisible(true);
            }
        });
    }
