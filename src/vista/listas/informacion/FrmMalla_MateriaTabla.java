 ...
 * @author Usuario iTC
 */
public class FrmMalla_MateriaTabla extends javax.swing.JFrame {
    
    Malla_materiaController dc = new Malla_materiaController();
    ModeloTablaMallaMateria mtd = new ModeloTablaMallaMateria();
    
    public FrmMalla_MateriaTabla() {
        initComponents();
     ...
     private void cargarTabla(){
        mtd.setMallasMaterias(dc.getMallasMaterias());
...
//    }
    ...
    private void initComponents() {
        ...
        labelRound1.setText("Registro de las Mallas-Materias-Ciclos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMalla_MateriaTabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmMalla_MateriaTabla().setVisible(true);
            }
        });
    }
