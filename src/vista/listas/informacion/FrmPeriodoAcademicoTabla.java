 ...
 * @author Usuario iTC
 */
public class FrmPeriodoAcademicoTabla extends javax.swing.JFrame {
    
    PeriodoAcademicoController dc = new PeriodoAcademicoController();
    ModeloTablaPeriodoAcademico mtd = new ModeloTablaPeriodoAcademico();
    
    public FrmPeriodoAcademicoTabla() {
        initComponents();
     ...
     private void cargarTabla(){
        mtd.setPeriodos(dc.getPeriodos());
...
//    }
    ...
    private void initComponents() {
        ...
        labelRound1.setText("Registros de los Periodos Academicos ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPeriodoAcademicoTabla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPeriodoAcademicoTabla().setVisible(true);
            }
        });
    }
