...
public class FrmCiclo extends javax.swing.JFrame {
    ...
    private CicloController gc = new CicloController();
    private ModeloTablaCiclo mtg = new ModeloTablaCiclo();
    ...
    public void guardar() {
        if (validar()) {
            try {
                ...
                ciclo.setNombre(txtNombre.getText());
                gc.setCiclo(ciclo);
                gc.guardar();
                gc.setCiclo(null);
                limpiar();
    ...
    private void modificar() {
        try {
            ...
            Ciclo cicloSeleccionado = mtg.getCiclos().get(filaSeleccionada);

            cicloSeleccionado.setNombre(txtNombre.getText());

            gc.modificar(cicloSeleccionado);
