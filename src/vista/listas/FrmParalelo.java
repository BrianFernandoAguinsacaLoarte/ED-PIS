...
import vista.listas.tablas.ModeloTablaParalelo;
...
public class FrmParalelo extends javax.swing.JFrame {
    ...
    private ParaleloController pc = new ParaleloController();
    private ModeloTablaParalelo mtg = new ModeloTablaParalelo();
    ...
    public void guardar() {
        if (validar()) {
            try {
                ...
                paralelo.setNombre(txtNombre.getText());
                pc.setParalelo(paralelo);
                pc.guardar();
                pc.setParalelo(null);
                limpiar();
            } catch (Exception e) {
    ...
    private void modificar() {
        try {
            ...
            Paralelo RolesSeleccionados = mtg.getParalelos().get(filaSeleccionada);

            RolesSeleccionados.setNombre(txtNombre.getText());

            pc.modificar(RolesSeleccionados);
    ...
    private void cargarVista(){
        pc.setIndex(jTableGenero.getSelectedRow());
        if(pc.getIndex().intValue() < 0){
            JOptionPane.showMessageDialog(null, "Selecciona una fila", 
                    "Error", JOptionPane.ERROR_MESSAGE);
        }else{
            try {
                pc.setParalelo(mtg.getParalelos().get(pc.getIndex()));
                txtNombre.setText(pc.getParalelo().getNombre());
    ...
    private void initComponents() {
        ...
        labelRound1.setText("Registro de los Paralelos\n");
