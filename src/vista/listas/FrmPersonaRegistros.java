 ...
 * @author Usuario iTC
 */
public class FrmPersonaRegistros extends javax.swing.JDialog {
    
    //Objetos
    PersonaController pc = new PersonaController();
    ModeloTablaPersona mtp = new ModeloTablaPersona();
    
    public FrmPersonaRegistros(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cargarTabla();
    ...
    private void initComponents() {
        ...
        jPanel1.add(cbxAscDesc, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 150, -1, 40));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 540, 160, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPersonaRegistros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmPersonaRegistros dialog = new FrmPersonaRegistros(new javax.swing.JFrame(), true);
