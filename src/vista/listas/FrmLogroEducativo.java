 ...
 * @author Usuario iTC
 */
public class FrmLogroEducativo extends javax.swing.JFrame {

    private LogroEducativoController tl = new LogroEducativoController();
    private ModeloTablaLogroEducativo mtg = new ModeloTablaLogroEducativo();

    /**
     * Creates new form FrmCurso
     */
    public FrmLogroEducativo() {
        initComponents();
    ...
    private void limpiar() {
        ...
        try {
            ...
            UtilVista.cargarTipoLogro(cbxTipo);
        } catch (Exception e) {
        }
        tl.setLogroEducativo(null);
    ...
    public void cargarTabla() {
        mtg.setLogros(tl.getLista());
        jTableLogroEducativo.setModel(mtg);
        jTableLogroEducativo.updateUI();
    }

    public void guardar() {
        if (validar()) {
            try {
                LogroEducativo logro = new LogroEducativo();
                logro.setNombre(txtNombre.getText());
                logro.setId_docente(UtilVista.getCargarDocente(cbxDocente).getId());
                logro.setId_tipoLogro(UtilVista.getComboTipoLogro(cbxTipo).getId());

                tl.setLogroEducativo(logro);
                tl.guardar();
                tl.setLogroEducativo(null);
                limpiar();
            } catch (Exception e) {
    ...
    private void modificar() {
        try {
            int filaSeleccionada = jTableLogroEducativo.getSelectedRow();
            ...
            LogroEducativo logroSel = mtg.getLogros().get(filaSeleccionada);

            logroSel.setNombre(txtNombre.getText());
            logroSel.setId_docente(UtilVista.getCargarDocente(cbxDocente).getId());
            logroSel.setId_tipoLogro(UtilVista.getComboTipoLogro(cbxTipo).getId());
            tl.modificar(logroSel);
    ...
    private void initComponents() {
        ...
        jTableLogroEducativo = new javax.swing.JTable();
        ...
        cbxTipo = new org.edisoncor.gui.comboBox.ComboBoxRect();
        cbxDocente = new org.edisoncor.gui.comboBox.ComboBoxRect();
        ...
        labelRect2.setText("Tipo De Logro:");
        ...
        jTableLogroEducativo.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(jTableLogroEducativo);
        ...
        panel1.add(cbxTipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 220, 400, 30));
        panel1.add(cbxDocente, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 170, 400, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmLogroEducativo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private org.edisoncor.gui.comboBox.ComboBoxRect cbxDocente;
    private org.edisoncor.gui.comboBox.ComboBoxRect cbxTipo;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JTable jTableLogroEducativo;
