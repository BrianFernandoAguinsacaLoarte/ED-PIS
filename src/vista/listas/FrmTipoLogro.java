 ...
 * @author Usuario iTC
 */
public class FrmTipoLogro extends javax.swing.JFrame {

    
    private TipoLogroController tl = new TipoLogroController();
    private ModeloTablaTipoLogro mtg = new ModeloTablaTipoLogro();
    ...
    public void cargarTabla() {
        mtg.setTipos(tl.getLista());
        jTableTipoLogro.setModel(mtg);
        jTableTipoLogro.updateUI();
    }

    public void guardar() {
        if (validar()) {
            try {
                TipoLogro tipo =  new TipoLogro();
                tipo.setNombre(txtNombre.getText());
                tl.setTipoLogro(tipo);
                tl.guardar();
                tl.setTipoLogro(null);
                limpiar();
            } catch (Exception e) {
...
//    }
    ...
    private void modificar() {
        try {
            int filaSeleccionada = jTableTipoLogro.getSelectedRow();
            ...
            TipoLogro tipoSel = mtg.getTipos().get(filaSeleccionada);

            tipoSel.setNombre(txtNombre.getText());

            tl.modificar(tipoSel);
    ...
    private void initComponents() {
        ...
        jTableTipoLogro = new javax.swing.JTable();
        ...
        jTableTipoLogro.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(jTableTipoLogro);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmTipoLogro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable jTableTipoLogro;
