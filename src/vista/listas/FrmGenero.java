...
public class FrmGenero extends javax.swing.JFrame {
    ...
    private GeneroController gc = new GeneroController();
    private ModeloTablaGenero mtg = new ModeloTablaGenero();
    ...
    private void modificar() {
        try {
            ...
            Genero cicloSeleccionado = mtg.getGeneros().get(filaSeleccionada);
