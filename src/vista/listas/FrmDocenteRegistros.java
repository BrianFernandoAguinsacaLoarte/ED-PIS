 ...
 * @author Usuario iTC
 */
public class FrmDocenteRegistros extends javax.swing.JDialog {
    ...
    public FrmDocenteRegistros(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cargarTabla();
    ...
    private void initComponents() {
        ...
        cbxCriterio.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "TITULO", "ESPECIALIZACION", "EXPERIENCIA LABORAL", "CERTIFICACIONES", "ID_PERSONA" }));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 530, 160, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDocenteRegistros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmDocenteRegistros dialog = new FrmDocenteRegistros(new javax.swing.JFrame(), true);
