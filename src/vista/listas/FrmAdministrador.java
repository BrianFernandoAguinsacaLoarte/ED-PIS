...
import vista.listas.tablas.ModeloTablaAdministrador;
...
public class FrmAdministrador extends javax.swing.JFrame {
    ...
    AdministradorController dc = new AdministradorController();
    ModeloTablaAdministrador mtd = new ModeloTablaAdministrador();
    ...
    public void cargarTabla() {
        mtd.setAdministradores(dc.getLista());
    ...
    private void limpiar() {
        ...
        try {
            ...
            UtilVista.cargarRoles(cbxRol, "Administrador");
        } catch (Exception e) {
        }
     ...
     private void modificar() {
        try {
            ...
            Administrador docente = mtd.getAdministradores().get(filaSeleccionada);
    ...
    private void cargarVista(){
        ...
        if(dc.getIndex().intValue() < 0){
            ...
            try {
                dc.setAdministrador(mtd.getAdministradores().get(dc.getIndex()));
                txtNombre.setText(dc.getAdministrador().getNombres());
                txtApellido.setText(dc.getAdministrador().getApellidos());
                txtCorreo.setText(dc.getAdministrador().getCorreo());
                jDate.setDate(dc.getAdministrador().getFechaNacimiento());
                UtilVista.setComboGenero(cbxGenero, dc.getAdministrador().getId_genero());
                txtCedula.setText(dc.getAdministrador().getCedula());
                txtDireccion.setText(dc.getAdministrador().getDireccion());
                txtTelefono.setText(dc.getAdministrador().getTelefono());
